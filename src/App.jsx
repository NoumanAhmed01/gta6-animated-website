        ...
        <div className="main w-full rotate-[-10deg] scale-[1.7] overflow-hidden">
          <div className="landing overflow-hidden relative w-full h-screen bg-black">
            ...
            <div className="imagesdiv relative overflow-hidden w-full h-screen">
              ...
              <img
               className="absolute character bottom-[-40%] right-[-10%] scale-[1.5] rotate-[-20deg]"
                src="./girlbg.png"
                alt=""
              />
            </div>
            <div className="btmbar text-white absolute bottom-0 left-0 w-full py-15 px-10 bg-linear-to-t from-black to-transparent">
              ...
              <img
                className="absolute h-13.75 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                src="./ps5.png"
                alt=""
              />
            </div>
            ...
            <div className="cntnr flex text-white w-full h-[80%] ">
              ...
              <div className="rg w-[30%]">
                ...
                <p className="mt-10 text-xl font-[Helvetica_Now_Display]">
                  ...
                  Distinctio possimus, asperiores nam,Lorem, ipsum.
                  voluptate.
                </p>
